    ...
    cn: [
            {
                ...
                content: {
                    ...
                    descripation: "GAME.FUND是基于理想的游戏社区，是可以耕植梦想的游戏开发社区，是我们倾力打造的真正属于您的《绿洲》。加入我们的赏金任务计划，不仅是可以通过任务来获取赏金奖励，您还可以成为我们的创立伙伴。",
                    ...
                    join: ["参与悬赏任务的用户需要有GAME.FUND账号，可参与的悬赏任务以具体任务规则为准。",
                        ...
                        "参与悬赏任务的用户的推文、博文或者视频必须是对GAME.FUND的正面表现，作品中有贬低内容、不实信息都会失去任务资格。",
                    ...
                    rule: ["Official website：<a href='https://GAME.FUND/gfg.html' target='_blank'>https://GAME.FUND/gfg.html</a>",
                        ...
                        "YouTube：<a href='https://www.youtube.com/channel/UCXSE7VV9rRfio_EmXHSHTPw' target='_blank'>https://www.youtube.com/channel/UCXSE7VV9rRfio_EmXHSHTPw</a>",
            ...
            },
            {
                ...
                content: {
                    ...
                    descripation: "我们需要您的加入，成为GAME.FUND的一份子。",               
                    award: ["赏金总额的10%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
                            "成功加入可获得5个GFG；",
                            "用户根据活跃评级可获得相应的额外GFG奖励：<br/>不活跃可获得0个GFG；<br/>达到一般活跃评级可获得10个GFG；<br/>达到积极用户评级可获得20个GFG；<br/>达到激情用户评级可获得35个GFG；<br/>达到狂热用户评级可获得50个GFG。"],
            ...
            //     content: {
            //         titleArray: ["任务描述", "奖励", "如何加入", "规则说明"],
            //         descripation: "通过KYC审核，您将更接近GAME.FUND。",              
            //         award: ["赏金总额的5%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
            //                 "通过KYC审核可获得100个GFG。"],
                
            //         join: ["成功注册GAME.FUND账号并通过KYC审核。",
            //                 "通过审核后系统将自动发放奖励至绑定钱包。"],
            ...
            // },
            {
                ...
                content: {
                    ...
                    award: ["赏金总额的15%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
                            "关注GAME.FUND官推可获得5个GFG。",
                            "30人以下关注者，每次转推获得1个GFG；<br/>31-100关注者，每次转推获得10个GFG；<br/>101-500关注者，每次转推获得50个GFG；<br/>501-1000关注者，每次转推获得100个GFG；<br/>1001-3000关注者，每次转推获得300个GFG；<br/>3000人以上关注者，每次转推获得500个GFG。"],
                    ...
                    rule: ["用户的Twitter账号的注册时长需要大于2个月。",
                        ...
                        "用户需要保持一定的活跃度，每周至少转发GAME.FUND的官方推文2次。每天最多转推1次。",
                        "用户Twitter的关注数量以提交登记表单时官方审核确认的数量为准。",
                        "用户的推文或转推对GAME.FUND的表现必须是正面的，出现任何贬低、不实的信息都会失去任务资格。",
            ...
            },
            {
                ...
                content: {
                    ...
                    award: ["赏金总额的30%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
                            "获得GFG的数量由作品内容的质量决定（文章经过官方审查后确定质量评级）。<br/>拒绝：获得0个GFG；<br/>普通：获得1500个GFG；<br/>优良：获得5000个GFG；<br/>卓越：获得9000个GFG。",
                            "文章被官方转载可以获得额外的GFG。<br/>普通：获得1000个GFG；<br/>优良：获得1500个GFG；<br/>卓越：获得2000个GFG。"],
                    
                    join: ["填写并提交此表格（发布文章后操作）：<a href='https://goo.gl/forms/fucIjDQoyDZXUGro1' target='_blank'>登记表单</a>",
                        "将文章发送到邮箱（附上登记表单中的填写信息）：<a href='mailto:info@game.fund' target='_blank'>GAME.FUND投递邮箱地址</a>"],
                    
                    rule: ["用户的博客或论坛账号的开通时长需要大于2个月。",
                        "文章内容需要有价值并且与GAME.FUND相关，如：白皮书的各方面内容、交易服务、GFG升值前景、技术相关等。",
                        "英文内容必须不少于300个词，中文内容不少于500字。",
                        "文章内容中至少有GAME.FUND官网、电报群、官推链接中的1个。",
            ...
            },
            {
                ...
                content: {
                    titleArray: ["任务描述", "奖励", "如何加入", "规则说明"],
                    descripation: "如果您对GAME.FUND感兴趣，同时又精通视频编辑和创作，那这个任务对您来说再合适不过了。",       
                    award: ["赏金总额的10%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
                            "关注GAME.FUND官方频道可获得5个GFG。",
                            "获得GFG的数量由作品的质量决定（视频经过审查后由官方决定质量评级）。<br/>拒绝：获得0个GFG；<br/>普通：获得5000个GFG；<br/>优良：获得15000个GFG；<br/>卓越：获得30000个GFG。",
                            "视频被官方转载可以获得额外的GFG。<br/>普通：获得1500个GFG；<br/>优良：获得3000个GFG；<br/>卓越：获得5000个GFG。"],         
                    
                    join: ["在YouTube上关注我们的频道：<a href='https://www.youtube.com/channel/UCXSE7VV9rRfio_EmXHSHTPw' target='_blank'>YouTube官方频道</a>",
                    ...
                    rule: ["用户的YouTube频道开通时长需要大于2个月。",
                        "视频内容需要有价值并且与GAME.FUND相关，或与GAME.FUND社交媒体渠道发布的官方内容相关。",
                        "视频中至少展示GAME.FUND官网地址或者电报群地址中的一个，展示的时长不能少于5秒；展示的效果需要能够看清楚，显示方法不限。",
                        "视频时长不能少于90秒。",
                        "视频需要有人声配音。",
            ...
            /*{
                ...
                content: {
                    ...
                    award: ["赏金总额的5%将作为此任务的赏金奖励给所有符合条件的任务参与者。",          
                            "白皮书翻译获得GFG的数量由译文的质量决定（译文经过审查后由官方决定质量评级）。<br/>较差：获得0个GFG；<br/>普通：获得2000个GFG；<br/>良好：获得3000个GFG；<br/>优秀：获得4000个GFG。",
                            "白皮书翻译如同时有多个任务参与者并且最终都完成了翻译任务，则最终官方采用译文的翻译者将额外获得100个GFG。",
                            "文案翻译获得GFG的数量由译文的质量决定（译文经过审核后由官方决定质量评级）。<br/>较差：获得0个GFG；<br/>普通：获得100个GFG；<br/>良好：获得200个GFG；<br/>优秀：获得300个GFG。",
                            "审核白皮书译文单个语种单篇可获得200个GFG；<br/>审核文案单个语种单篇可获得50个GFG。",],         
            ...
            },
            {
                ...
                content: {
                    titleArray: ["任务描述", "奖励", "如何加入", "规则说明"],
                    descripation: "只要您成功注册了GAME.FUND就可以通过参与我们的推广悬赏任务来获得奖励。",                
                    award: ["赏金总额的5%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
                            "每成功邀请一个用户注册GAME.FUND账号可获得2个GFG奖励。",
                            "每成功邀请一个用户注册GAME.FUND账号并且加入GAME.FUND电报群可再获得3个GFG奖励。",
                            "每成功邀请一个用户并且通过了KYC审核可获得20个GFG奖励。"],
                    
                    join: ["只有注册了GAME.FUND账号的用户才能获得普通推广者身份。",
                        "拥有推广者身份的用户，可通过GAME.FUND官网领取带有个人标识的二维码进行推广。"],
                    
                    rule: ["用户需要在GAME.FUND成功注册才可领取该任务。",
                        "用户需要加入GAME.FUND电报群并且不能退群，如果退群，官方保留取消该推广者身份的权利。",
                        "普通推广者在通过了KYC审核后会自动提升为高级推广者，之前推广建立的管道依然有效。",
                        "推广者不得使用欺诈、隐瞒等手段来邀请用户，如发现违规行为，官方保留取消其推广者身份的权利。",
                        "推广者在推广过程中的所有行为都需要是正面的，任何对GAME.FUND产生负面影响的推广者都将失去推广者身份。",
            ...
            },
            {
                ...
                content: {
                    ...
                    award: ["赏金总额的15%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
                            ...
                            "每成功邀请一个用户注册GAME.FUND账号并且加入GAME.FUND电报群可再获得3个GFG奖励。",
                            "每成功邀请一个用户并且通过了KYC审核可获得20个GFG奖励。",
                            "通过个人邀请码被邀请的用户完成注册将和您建立管道关系。您邀请的用户再通过他本人的邀请码所邀请的用户也可以和您建立管道关系，依此类推您最多可建立3层管道关系，即：您——>您邀请的用户A（A为群组，指您邀请的所有用户）——>A邀请的用户B（B为群组，指A群组内用户所邀请的所有用户）——>B邀请的用户C（C为群组，指B群组内用户所邀请的所有用户）。建立管道后，您所建立的管道内用户如果购买GFG币，您将获得奖励。奖励额度为：<br/>A购买GFG总量的4%；<br/>B购买GFG总量的0.7%；<br/>C购买GFG总量的0.3%。",
                            "管道内用户单笔购买完成后将及时结算奖励发放到您绑定的钱包内。"],

                    join: ["只有通过KYC审核的用户才能获得高级推广者身份。",
                        "拥有推广者身份的用户，可通过GAME.FUND官网领取带有个人标识的二维码进行推广。"],

                    rule: ["用户需要在GAME.FUND进行注册并且通过KYC审核才可进行该任务。",
                        "用户需要加入GAME.FUND电报群并且不能退群，如果退群，官方保留取消该推广者身份的权利。",
            ...
            },
            {
                ...
                content: {
                    titleArray: ["任务描述", "奖励", "如何加入", "规则说明"],
                    descripation: "您是媒体工作者或者渠道管理人员吗？您有更好、更有效的办法来推广GAME.FUND吗？如果答案是肯定的，那太好了！请立刻联系我们，关于推广方法和奖励方案我们可以直接沟通。",              
                    award: ["赏金总额的25%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
                            "详细的奖励方案由双方沟通后确定。"],
                    
                    join: ["发送邮件至<a href='mailto:info@game.fund' target='_blank'>GAME.FUND投递邮箱地址</a>，邮件内容需要注明：<br/>-标题带有渠道推广；<br/>-您的所在地和推广经验；<br/>-具体的推广方式；<br/>-联系方式。",
                        "我们在确认信息后会主动与您联系。"],
                    
                    rule: ["GAME.FUND会对渠道能力进行评估，如果认为渠道能力不足，或者最终推广效果不佳，将会终止推广任务。",
                        "确认推广关系后，奖励方案不可单方面更改。",
    ...
    en: [
            ...
            /*{
                ...
                content: {
                    ...
                    descripation: "Via Know-your-customer review, you will be closer to GAME.FUND.",              
                    award: ["5% of total sum of the bounty will be paid to task participants that are eligible for the task. ",
                            "You can get 100 GFG if you pass Know-your-customer review."],
                
                    join: ["Register a GAME.FUND ID successfully and pass Know-your-customer review.",
                            "After passing the review, the system will send 100 GFG reward to your bound wallet automatically."],
            ...
            /*{
                ...
                content: {
                    ...
                    award: ["5% of total sum of the bounty will be paid to task participants that are eligible.",          
                            'Reward quantity of GFG from white paper translation will be decided by the quality of the translation (The translation will be rated by the official authority after review.)<br/>If your translation is rated as "Poor",you will get 0 GFG. <br/>If your translation is rated as "Average",you will get 2000 GFG.<br/>If your translation is rated as "Good", you will get 3000 GFG.<br/>If your translation is rated as "Excellent", you will get 4000 GFG. ',
                            "If many participants participate in the translation of white paper and all finish the task,the translator whose translation is adopted by the official authority will get additional 100 GFG.",
                            'Reward quantity of GFG from copywriting translation will be decided by the translation quality (The translation will be rated by the official authority after review.)<br/>If your translation is rated as "Poor",you will get 0 GFG.<br/>If your translation is rated as "Average",you will get 100 GFG.<br/>If your translation is rated as "Good", you will get 200 GFG.<br/>If your translation is rated as "Excellent", you will get 300 GFG .',
                            "You can get 200 GFG if you review and verify monolingual white paper translation.<br/>You can get 50 GFG if you review and verify monolingual copywriting translation.",],         
            ...
            },
            {
                ...
                content: {
                    titleArray: ["Task Description", "Reward", "How to join", "Rules explanation"],
                    descripation: "Tell you a good news. As long as you register successfully in GAME.FUND, you can get reward through participation in our promotion task.",                
                    award: ["5% of total sum of the bounty will be paid to task participants that are eligible for this task . ",
                            "You will get 2 GFG as a reward after you invite one user to register a GAME.FUND ID successfully.",
                            "You will get 3 GFG as a reward after you invite one user to register a GAME.FUND ID successfully and to join our telegram group successfully. ",
                            "You will get 20 GFG as a reward after you invite one user and this user pass KYC review successfully."],
                    
                    join: ["Only users that register successfully in GAME.FUND can have the identity as general promoters.",
                        "Users that are given promoter identity, can receive a QR code with a personal logo in GAME.FUND official web site and then carry out the promotion with the QR code."],
                    
                    rule: ["Only users that register successfully in GAME.FUND can do this task.",
                        "Users that want to do this task must join telegram group and can not quit the group; If you quit the telegram group, GAME.FUND official authority reserves the right to cancel the identity of the promoter.",
                        ...
                        "The promoter's promotion behaviour must be positive to GAME.FUND image . Any promoter that brings negative influence to GAME.FUND will lose the identity of promoter.",
            ...
            },
            {
                ...
                content: {
                    ...
                    rule: ["Only users that register successfully in GAME.FUND and pass KYC review can do this task.",
                        "Users that want to do this task must join telegram group and can not quit the group; If you quit the telegram group, GAME.FUND official authority reserves the right to cancel the promoter identity.",
                        ...
                        "The promoter's promotion behaviour must be positive to GAME.FUND. Any promoter that brings negative influence to GAME.FUND will lose the identity of promoter.",
            ...
            },
            {
                ...
                content: {
                    titleArray: ["Task Description", "Reward", "How to join", "Rules explanation"],
                    descripation: "Are you media workers or channel administrative personnel ? Do you have better and more effective methods to promote GAME.FUND ? If the answer is YES, that would be great ! Please contact us immediately, and we can communicate directly with you about the promotion methods and reward programme  .",              
                    ...
                    join: ["Send emails to <a href='mailto:info@game.fund' target='_blank'>GAME.FUND email address</a>. Below contents must be included in your email.<br/>-The title must include promotion channels;<br/>-Your location and promotion experience ;<br/>-Specific promotion method<br/>-Contact information.",
